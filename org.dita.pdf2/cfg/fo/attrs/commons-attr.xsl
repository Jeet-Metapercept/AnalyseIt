...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="commons.text-indent" select="'80pt'"/>
    <xsl:variable name="side-col-width" select="'80pt'"/>
    ...
    <xsl:attribute-set name="__title__lines__image__left">
        ...
        <xsl:attribute name="left">-4.5pt</xsl:attribute>
    ...
    <xsl:attribute-set name="__title__lines__image__right">
        <xsl:attribute name="position">absolute</xsl:attribute>
        <xsl:attribute name="right">10pt</xsl:attribute>
    ...
    <xsl:attribute-set name="__chapter__frontmatter__number__container">
        ...
        <xsl:attribute name="left">11.8cm</xsl:attribute>
        <xsl:attribute name="position">absolute</xsl:attribute>
