...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--Custom add-->
    <xsl:attribute-set name="toc__title__lines__image__left">
    ...
    <!--<xsl:attribute-set name="toc__title__lines__image__right">
        <xsl:attribute name="position">absolute</xsl:attribute>
    ...
    <xsl:attribute-set name="__toc__topic__content">
        ...
        <!--Custom add-->
               <xsl:attribute name="text-align-start">justify</xsl:attribute>
        <!--end-->
        <xsl:attribute name="font-size">
            <xsl:variable name="level" select="count(ancestor-or-self::*[contains(@class, ' topic/topic ')])"/>
            <xsl:choose>
        ...
        <xsl:attribute name="font-weight">
            <xsl:variable name="level" select="count(ancestor-or-self::*[contains(@class, ' topic/topic ')])"/>
            <xsl:choose>
                <xsl:when test="$level = 1">500</xsl:when>
    ...
    <xsl:attribute-set name="__toc__leader">
        <xsl:attribute name="font-family">Apple</xsl:attribute>
        <xsl:attribute name="leader-pattern">hidden<!--dots--></xsl:attribute>
        <xsl:attribute name="leader-length">0.9cm</xsl:attribute>
    </xsl:attribute-set>
